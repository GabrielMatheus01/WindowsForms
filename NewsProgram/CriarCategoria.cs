...
namespace NewsProgram
{
    ...
    { // CONEXÃO COM O BANCO DE DADOS
        SqlConnection conn = new SqlConnection(@"workstation id=GabrielMatheus.mssql.somee.com;packet size=4096;user id=GabrielM_SQLLogin_1;pwd=fefls3vgll;data source=GabrielMatheus.mssql.somee.com;persist security info=False;initial catalog=GabrielMatheus");
